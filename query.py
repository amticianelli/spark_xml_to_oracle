...
class xmlToOracle:
    ...
    spark_capa = """
        SELECT
            ...
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,NFe.infNfe.total.ICMSTot.vProd),'.'),','),15,'0') AS VLR_PRODUTO,
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,NFe.infNfe.total.ICMSTot.vNF),'.'),','),15,'0') AS VLR_TOT_NOTA, 
            'N' AS SITUACAO,
            ...
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,XI.BASE_ISEN_ICMS),'.'),','),15,'0') AS BASE_ISEN_ICMS,
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,XI.BASE_OUTR_ICMS),'.'),','),15,'0') AS BASE_OUTR_ICMS,
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,XI.BASE_IPI),'.'),','),15,'0') AS BASE_OUTR_IPI,
            ...
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,NFe.infNfe.total.ICMSTot.vDesc),'.'),','),15,'0') AS VLR_DESCONTO,
            LPAD(REPLACE(REPLACE(NFe.infNfe.total.ICMSTot.vDesc,'.'),','),15,'0') AS VLR_ABAT_NTRIBUTADO
        FROM XML_RAW_CAPA
    ...
    spark_item = """
        SELECT
            ...
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,col.prod.vUnCom),'.'),','),15,'0') AS VLR_UNIT,
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,col.prod.vProd),'.'),','),15,'0') AS VLR_ITEM,
            NVL(CASE 
            ...
            LPAD(REPLACE(REPLACE(setTagAvulsa(NFe.infNfe.emit.CPF,NFe.infNfe.emit.IE,col.prod.vDesc),'.'),','),15,'0') AS VLR_DESCONTO,
            '03' AS COD_TRIB_IPI 
        FROM XML_RAW_ITEM
        LEFT JOIN X04_PESSOA_FIS_JUR X04 ON 1=1
            AND LPAD(NVL(NFe.infNfe.emit.CNPJ,NFe.infNfe.emit.CPF),14,'0') = LPAD(X04.CPF_CGC,14,'0')
